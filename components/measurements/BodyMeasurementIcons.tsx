...
function WeightPlaceholderGlyph({ size, color }: { size: number; color: string }) {
  const o = 'rgba(148,163,184,0.55)';
  return (
    <Svg width={size} height={size} viewBox={`0 0 ${VB} ${VB}`}>
      <Path d="M5.5 28.5 H30.5 Q31.5 28.5 31.5 29.5 V31 Q31.5 32.5 30.5 32.5 H5.5 Q4.5 32.5 4.5 31 V29.5 Q4.5 28.5 5.5 28.5 Z" stroke={o} strokeWidth={1.2} fill="none" />
      <Path d="M18 28.5 V20.5" stroke={o} strokeWidth={1.1} />
      <Path d="M18 20.5 L8.5 26.5 H27.5 L18 20.5" stroke={o} strokeWidth={1.05} fill="none" strokeLinejoin="round" />
      <Ellipse cx="9" cy="28" rx="3.6" ry="2.2" stroke={color} strokeWidth={1.25} fill={color} fillOpacity={0.14} />
      <Ellipse cx="27" cy="28" rx="3.6" ry="2.2" stroke={color} strokeWidth={1.25} fill={color} fillOpacity={0.14} />
      <Path
...
export function BodyMeasurementZoneIcon({
  ...
  if (zone === 'weight') {
    return (
      <View accessible accessibilityRole="image" accessibilityLabel={accessibilityLabel} style={box}>
  ...
  return (
    <View accessible accessibilityRole="image" accessibilityLabel={accessibilityLabel}>
      <Svg width={size} height={size} viewBox={`0 0 ${NOTES_VB} ${NOTES_VB}`}>
        ...
        />
        <Path d="M21.5 10.5 V14.5 H25.5" stroke={outlineColor} strokeWidth={1.15} fill="none" strokeLinejoin="round" />
        <Path
